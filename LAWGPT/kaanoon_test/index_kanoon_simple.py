"""
Simple script to index Kanoon Q&A data directly into ChromaDB
"""
import json
import chromadb
...
print("=" * 80)
print("KANOON Q&A INDEXING - SIMPLE VERSION")
print("=" * 80)
...
print(f"\n{'='*80}")
response = input(f"Index {len(documents)} documents into ChromaDB? (yes/no): ")

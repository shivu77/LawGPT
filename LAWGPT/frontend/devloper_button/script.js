...
// LAW-GPT Developers Title - scrolls down and goes behind mountains
gsap.set(".lawgpt-title-container", {
    opacity: 1,
    y: 0,
    zIndex: 2
});

let lawgptTitleTL = gsap.timeline();
ScrollTrigger.create({
    animation: lawgptTitleTL,
    trigger: ".scrollElement",
    start: "top top",
    end: "15% top",
    scrub: 3
...
// Title moves down significantly to go behind mountains (not just fade)
lawgptTitleTL.to(".lawgpt-title-container", {
    y: 800,
    scale: 0.6,
    ease: "power1.in"
}, 0);
...
// Developer Section - Sequential pop-up with fade in/out
// First Person (Dr. Sunil Saumya) - appears AFTER title hides
gsap.set(".guidance-card-first", {
    y: 250,
    opacity: 0,
    scale: 0.5,
    rotation: -10,
...
// First Person (Dr. Sunil) - appears after title goes behind mountains (starts at 15%)
let person1TL = gsap.timeline();
ScrollTrigger.create({
    animation: person1TL,
    trigger: ".scrollElement",
    start: "15% top",
...
// Fade in
person1TL.to(".guidance-card-first", {
    y: 0,
    opacity: 1,
    scale: 1,
    rotation: 0,
...
// Second Person (K N Nivedh) - appears BETWEEN sun and mountains
gsap.set(".developer-card", {
    y: 250,
    opacity: 0,
    scale: 0.5,
    rotation: 10,
...
// Second Person - appears and fades out
let person2TL = gsap.timeline();
ScrollTrigger.create({
    animation: person2TL,
    trigger: ".scrollElement",
    start: "35% top",
...
// Fade in with slight tilt (8 degrees)
person2TL.to(".developer-card", {
    y: 0,
    opacity: 1,
    scale: 1,
    rotation: 8,
...
// Third Person (Sudev Basti) - appears during NIGHT SCENE
gsap.set(".developer-card-second", {
    y: 250,
    opacity: 0,
    scale: 0.5,
    rotation: -8
...
// Third Person - appears during night scene
let person3TL = gsap.timeline();
ScrollTrigger.create({
    animation: person3TL,
    trigger: ".scrollElement",
    start: "62% top",
...
// Fade in
person3TL.to(".developer-card-second", {
    y: 0,
    opacity: 1,
    scale: 1,
    rotation: 0,
